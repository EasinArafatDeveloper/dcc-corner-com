...
export function HeroSlider({ 
  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-sm border border-[#E5E7EB] bg-slate-50 aspect-[16/9] sm:aspect-[21/9] lg:aspect-[2.4/1] xl:h-[460px] flex items-center">
        <Swiper
